...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyphenateRestApIs.Chatroom();
  });
  ...
  describe('Chatroom', function() {
    it('should create an instance of Chatroom', function() {
      // uncomment below and update the code to test Chatroom
      //var instane = new HyphenateRestApIs.Chatroom();
      //expect(instance).to.be.a(HyphenateRestApIs.Chatroom);
    });
