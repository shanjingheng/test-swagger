...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyphenateRestApIs.ModifyChatroom();
  });
  ...
  describe('ModifyChatroom', function() {
    it('should create an instance of ModifyChatroom', function() {
      // uncomment below and update the code to test ModifyChatroom
      //var instane = new HyphenateRestApIs.ModifyChatroom();
      //expect(instance).to.be.a(HyphenateRestApIs.ModifyChatroom);
    });
