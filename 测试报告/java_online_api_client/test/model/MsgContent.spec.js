...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyphenateRestApIs.MsgContent();
  });
  ...
  describe('MsgContent', function() {
    it('should create an instance of MsgContent', function() {
      // uncomment below and update the code to test MsgContent
      //var instane = new HyphenateRestApIs.MsgContent();
      //expect(instance).to.be.a(HyphenateRestApIs.MsgContent);
    });
