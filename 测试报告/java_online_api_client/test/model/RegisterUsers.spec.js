...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyphenateRestApIs.RegisterUsers();
  });
  ...
  describe('RegisterUsers', function() {
    it('should create an instance of RegisterUsers', function() {
      // uncomment below and update the code to test RegisterUsers
      //var instane = new HyphenateRestApIs.RegisterUsers();
      //expect(instance).to.be.a(HyphenateRestApIs.RegisterUsers);
    });
