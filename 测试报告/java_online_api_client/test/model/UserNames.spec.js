...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyphenateRestApIs.UserNames();
  });
  ...
  describe('UserNames', function() {
    it('should create an instance of UserNames', function() {
      // uncomment below and update the code to test UserNames
      //var instane = new HyphenateRestApIs.UserNames();
      //expect(instance).to.be.a(HyphenateRestApIs.UserNames);
    });
