...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyphenateRestApIs.NewOwner();
  });
  ...
  describe('NewOwner', function() {
    it('should create an instance of NewOwner', function() {
      // uncomment below and update the code to test NewOwner
      //var instane = new HyphenateRestApIs.NewOwner();
      //expect(instance).to.be.a(HyphenateRestApIs.NewOwner);
    });

    it('should have the property newowner (base name: "newowner")', function() {
