...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyphenateRestApIs.AuthenticationApi();
  });
  ...
  describe('AuthenticationApi', function() {
    describe('orgNameAppNameTokenPost', function() {
      it('should call orgNameAppNameTokenPost successfully', function(done) {
        //uncomment below and update the code to test orgNameAppNameTokenPost
        //instance.orgNameAppNameTokenPost(pet, function(error) {
