...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyphenateRestApIs.ChatHistoryApi();
  });
  ...
  describe('ChatHistoryApi', function() {
    describe('orgNameAppNameChatmessagesGet', function() {
      it('should call orgNameAppNameChatmessagesGet successfully', function(done) {
        //uncomment below and update the code to test orgNameAppNameChatmessagesGet
        //instance.orgNameAppNameChatmessagesGet(pet, function(error) {
