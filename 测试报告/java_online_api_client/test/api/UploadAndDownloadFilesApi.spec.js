...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyphenateRestApIs.UploadAndDownloadFilesApi();
  });
  ...
  describe('UploadAndDownloadFilesApi', function() {
    describe('orgNameAppNameChatfilesPost', function() {
      it('should call orgNameAppNameChatfilesPost successfully', function(done) {
        //uncomment below and update the code to test orgNameAppNameChatfilesPost
        //instance.orgNameAppNameChatfilesPost(pet, function(error) {
    ...
    describe('orgNameAppNameChatfilesUuidGet', function() {
      it('should call orgNameAppNameChatfilesUuidGet successfully', function(done) {
        //uncomment below and update the code to test orgNameAppNameChatfilesUuidGet
        //instance.orgNameAppNameChatfilesUuidGet(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
