...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyphenateRestApIs.ModifyGroup = factory(root.HyphenateRestApIs.ApiClient);
  }
  ...
  /**
   * The ModifyGroup model module.
   * @module model/ModifyGroup
   * @version 1.0.2
   */

  /**
   * Constructs a new <code>ModifyGroup</code>.
   * @alias module:model/ModifyGroup
   * @class
   */
  ...
  /**
   * Constructs a <code>ModifyGroup</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModifyGroup} obj Optional instance to populate.
   * @return {module:model/ModifyGroup} The populated <code>ModifyGroup</code> instance.
   */
