...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyphenateRestApIs.ModifyChatroom = factory(root.HyphenateRestApIs.ApiClient);
  }
  ...
  /**
   * The ModifyChatroom model module.
   * @module model/ModifyChatroom
   * @version 1.0.2
   */

  /**
   * Constructs a new <code>ModifyChatroom</code>.
   * @alias module:model/ModifyChatroom
   * @class
   */
  ...
  /**
   * Constructs a <code>ModifyChatroom</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModifyChatroom} obj Optional instance to populate.
   * @return {module:model/ModifyChatroom} The populated <code>ModifyChatroom</code> instance.
   */
