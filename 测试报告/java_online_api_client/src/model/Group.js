...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyphenateRestApIs.Group = factory(root.HyphenateRestApIs.ApiClient, root.HyphenateRestApIs.UserName);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('approval')) {
        obj['approval'] = ApiClient.convertToType(data['approval'], 'Boolean');
      }
