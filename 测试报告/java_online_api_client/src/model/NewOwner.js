...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyphenateRestApIs.NewOwner = factory(root.HyphenateRestApIs.ApiClient);
  }
  ...
  /**
   * The NewOwner model module.
   * @module model/NewOwner
   * @version 1.0.2
   */

  /**
   * Constructs a new <code>NewOwner</code>.
   * @alias module:model/NewOwner
   * @class
   */
  ...
  /**
   * Constructs a <code>NewOwner</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewOwner} obj Optional instance to populate.
   * @return {module:model/NewOwner} The populated <code>NewOwner</code> instance.
   */
   ...
   */
  exports.prototype['newowner'] = undefined;
