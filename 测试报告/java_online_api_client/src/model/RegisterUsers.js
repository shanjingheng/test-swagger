...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyphenateRestApIs.RegisterUsers = factory(root.HyphenateRestApIs.ApiClient, root.HyphenateRestApIs.User);
  }
  ...
  /**
   * The RegisterUsers model module.
   * @module model/RegisterUsers
   * @version 1.0.2
   */

  /**
   * Constructs a new <code>RegisterUsers</code>.
   * @alias module:model/RegisterUsers
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>RegisterUsers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RegisterUsers} obj Optional instance to populate.
   * @return {module:model/RegisterUsers} The populated <code>RegisterUsers</code> instance.
   */
