...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyphenateRestApIs.UserNames = factory(root.HyphenateRestApIs.ApiClient, root.HyphenateRestApIs.UserName);
  }
  ...
  /**
   * The UserNames model module.
   * @module model/UserNames
   * @version 1.0.2
   */

  /**
   * Constructs a new <code>UserNames</code>.
   * @alias module:model/UserNames
   * @class
   */
  ...
  /**
   * Constructs a <code>UserNames</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserNames} obj Optional instance to populate.
   * @return {module:model/UserNames} The populated <code>UserNames</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('usernames')) {
        obj['usernames'] = UserName.constructFromObject(data['usernames']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/UserName} usernames
   */
